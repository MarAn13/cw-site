...
<body>
    ...
    <div class="container-fluid p-3 mainContentDiv">
        <div class="container-fluid bg-dark text-light rounded fs-5 mainContentBgDiv">
            ...
            $total_pages = specialist_get_current_total_pages($_SESSION['specialist']);
            if (isset($_GET['page_num']) && $_GET['page_num'] > 0 && $_GET['page_num'] <= $total_pages) {
                $current_page = $_GET['page_num'];
            } else {
                $current_page = 1;
            }
            specialist_show_current_orders($_SESSION['specialist'], ($current_page - 1));
            ?>
            <div>
                <?php
                echo
...
include_once('footer.html');
    ...
    <!-- own js -->
    <script src="../../js/specialist/currentOrders.js"></script>
