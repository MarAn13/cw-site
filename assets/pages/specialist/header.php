        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a id="header_orderDesk" class="nav-link" aria-current="page" href="
                        <?php
                        echo $link_add;
                        ?>orderDesk.php">Order
                            desk</a>
                    ...
                    <li class="nav-item">
                        <a id="header_currentOrders" class="nav-link" aria-current="page" href="
                        <?php
                        echo $link_add;
                        ?>currentOrders.php">Current orders</a>
                    </li>
                    <li class="nav-item">
                        <a id="header_orderHistory" class="nav-link" href="
                        <?php
                        echo $link_add;
                        ?>orderHistory.php">History</a>
                    </li>
                </ul>
                <a href="<?php
                            if ($link === 'account.php') {
