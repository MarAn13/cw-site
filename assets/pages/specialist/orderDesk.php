...
<body>
    ...
    <!-- own js -->
    <script src="../../js/specialist/orderDesk.js"></script>
    ...
    $(document).ready(function(){";
        if ($_GET['operation'] == 'error') {
            echo "alert('Error occurred. The order might have been taken');";
        }
        if ($_GET['operation'] == "orderLimit") {
            echo "alert('Error occurred. You already have the maximum number of orders');";
        }
        if ($_GET['operation'] == "success") {
            echo "alert('Order successfully accepted');";
        }
        echo
        "});</script>";
    }
