...
<body>
    ...
    <!-- own js -->
    <script src="../../js/admin/reportHistory.js"></script>
    ...
    $(document).ready(function(){";
        if ($_GET['operation'] == 'approve') {
            echo "alert('The order was successfully approved');";
        }
        if ($_GET['operation'] == "decline") {
            echo "alert('The order was successfully declined');";
        }
        echo
        "});</script>";
    }
