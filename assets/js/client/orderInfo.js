    ...
    success: function (data) {
      if (data !== "no_new_messages") {
        ...
        data[0].forEach(function (arr) {
          ...
          if (arr[1] === 'client'){
            arr[1] === 'me';
            newMessage = "<div class='client-message-div bg-primary float-end mb-3 d-inline-block rounded-3'><p class='px-1 text-info'>me " + 
            arr[2].toString() + "</p><p class='px-1 text-white'>" + arr[0].toString() + "</p></div>";
          }else{
            newMessage = "<div class='specialist-message-div bg-secondary mb-3 d-inline-block rounded-3'><p class='px-1 text-warning'>specialist " + 
            arr[2].toString() + "</p><p class='px-1 text-white'>" + arr[0].toString() + "</p></div>";
          }
